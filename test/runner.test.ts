...
describe("runSession (integracja z atrapą claude)", () => {
  ...
  it(
    "zwraca sukces i podsumowanie z result",
    async () => {
  ...
  it(
    "zwraca błąd, gdy result ma is_error",
    async () => {
      const config = buildConfig({
        command: fakeClaudePath,
  ...
  it(
    "zwraca błąd z kodem wyjścia przy niezerowym kodzie",
    async () => {
      const config = buildConfig({
        command: fakeClaudePath,
  ...
  it(
    "zwraca błąd spawn, gdy komendy nie ma",
    async () => {
  ...
  it(
    "ubija sesję po przekroczeniu timeoutu",
    async () => {
      const config = buildConfig({
        command: fakeClaudePath,
  ...
  it(
    "przerywa sesję na sygnał abort",
    async () => {
      const config = buildConfig({
        command: fakeClaudePath,
        childEnv: childEnv("hang"),
  ...
  it(
    "przekazuje prompt na stdin procesu potomnego",
    async () => {
